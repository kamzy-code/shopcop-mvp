...
export const cacVerificationSchema = z.object({
  ...
  cac_company_type: z.enum(['LIMITED_LIABILITY', 'BUSINESS_NAME', 'INCORPORATED_TRUSTEES'], {
...
export const smedanVerificationSchema = z.object({
  ...
  smedan_business_type: z.enum(['SOLE_PROPRIETOR', 'PARTNERSHIP', 'COOPERATIVE'], {
...
export const productSchema = z.object({
  ...
  stock_quantity: z.number().int('Must be a whole number').min(0, 'Cannot be negative').optional(),
});
